...
class FunkTrail extends FlxTrail
{
  ...
  override function addTrailFrame():Void
  {
    ...
    {
      var targ:Character = cast target;
      @:privateAccess
      frameOffset.set((targ.animOffsets2[0] - targ.globalOffsets[0]) * targ.scale.x, (targ.animOffsets2[1] - targ.globalOffsets[1]) * targ.scale.y);
